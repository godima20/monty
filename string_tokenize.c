...
/**
 * strtow - takes a string and seprate its words
 * @str: A string to separate into words
 * @delims: delimetors to use to delimit words
 *
 ...
 * @delims: Pointer to null terminated array delimitors
 *
...
/**
 * get_next_word - Gets the next word in the string
 * @str: string to get the bext word
 * @delims: delimitors to use to delimit words
 *
